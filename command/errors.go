...
// Returns new `*ErrAggregatedEvent` caused by `event` or `Event`s dispatched while processing `event`
...
// Returns list of all `error`s caused by processing initial 'Event'
// or `Event`s dispatched while processing this `Event`
